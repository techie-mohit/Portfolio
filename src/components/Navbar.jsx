...
const NavBar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto flex items-center justify-between">
          ...
          <button
            ...
            className="lg:hidden flex flex-col justify-center items-center w-8 h-8 space-y-1.5 focus:outline-none z-50 group cursor-pointer"
      ...
      <div
        className={`fixed inset-0 bg-black/98 backdrop-blur-3xl transition-all duration-500 z-[95] lg:hidden flex flex-col justify-center items-center px-8 py-16 ${
          ...
          <ul className="flex flex-col space-y-8">
            ...
            <li className="flex flex-col gap-4 justify-center items-center">
              <a
                ...
                download="Mohit_Keshari_Resume.pdf"
                onClick={() => setIsOpen(false)}
                className="w-full max-w-xs text-center bg-white/[0.05] border border-white/10 text-white font-extrabold text-base uppercase px-8 py-3.5 rounded-2xl shadow-xl transition-all duration-300 cursor-pointer"
              >
                Download Resume
              </a>
              <a
                href="#contact"
                onClick={() => setIsOpen(false)}
                className="w-full max-w-xs text-center bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white font-extrabold text-base uppercase px-8 py-3.5 rounded-2xl shadow-xl transition-all duration-300 cursor-pointer"
              >
                Contact me
              </a>
            </li>
